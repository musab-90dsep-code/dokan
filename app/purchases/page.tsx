...
export default function PurchasesPage() {
  ...
  const autoGeneratedName = useMemo(() => {
    if (itemCategory === 'রড') {
      const brand = rodBrand ? ` ${rodBrand}` : '';
      return `${rodMili}${brand} রড`;
    }
    if (itemCategory === 'সিমেন্ট') {
      return cementBrand ? `${cementBrand} সিমেন্ট` : 'সিমেন্ট';
    }
    if (itemCategory === 'রিং') {
      const note = ringNote ? ` (${ringNote})` : '';
      return `${ringSize} রিং${note}`;
    }
    return genericName || 'অন্যান্য পণ্য';
